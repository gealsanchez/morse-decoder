...
<ul>
<li>cd my-folder</li>
<li>git clone git@github.com:gealsanchez/morse-decoder.git</li>
</ul>
...
This project is [MIT](https://github.com/gealsanchez/morse-decoder/blob/dev/LICENSE) licensed.
